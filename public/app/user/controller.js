angular.module("app.user.controller", ["ngResource", "ngRoute"])
    .controller("userController", ['$scope', '$location', '$routeParams', '$http', 'categoriesLookupFactory', 'categoryLookupFactory',
            function($scope, $location, $routeParams, $http, categoriesLookupFactory, categoryLookupFactory) {
        $scope.user = {};
        $scope.categories = [{}];
        $scope.category = {};
    ...
    .controller("userListController",['$scope', '$resource', '$location', function($scope, $resource, $location) {
        $scope.categories = [];
        //$scope.products = [{}];
