 ...
 *
 * This is a direct copy of twitter's local interface being used as a generic container of thread local data to propagate
 * across execution contexts.
 *
 * At the time of this dirty copy and pasting this version of the class is part of 6.20.1-SNAPSHOT and has not been published.
 * Eventually it would be nice to just include this properly as a library, but the last published tag (6.12.1) has not been
